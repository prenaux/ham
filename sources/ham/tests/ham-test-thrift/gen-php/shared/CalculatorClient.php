...
class CalculatorClient extends \shared\SharedServiceClient implements \shared\CalculatorIf
{
    ...
    {
        $args = new \shared\Calculator_ping_args();
    ...
    public function recv_ping()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \shared\Calculator_ping_result();
    ...
    {
        $args = new \shared\Calculator_add_args();
        $args->num1 = $num1;
        $args->num2 = $num2;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_add()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \shared\Calculator_add_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
    ...
    public function calculate($logid, \shared\Work $w)
    {
        $this->send_calculate($logid, $w);
        return $this->recv_calculate();
    }

    public function send_calculate($logid, \shared\Work $w)
    {
        $args = new \shared\Calculator_calculate_args();
        $args->logid = $logid;
        $args->w = $w;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
    ...
    public function recv_calculate()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\shared\Calculator_calculate_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \shared\Calculator_calculate_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
    ...
    {
        $args = new \shared\Calculator_zip_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
