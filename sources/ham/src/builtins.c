...
void load_builtins() {
  ...
  bindrule("fexists")->procedure = bindrule("FExists")->procedure =
    bindrule("FEXISTS")->procedure =
      parse_make(builtin_fexists, P0, P0, P0, C0, C0, 0);

  bindrule("fisdir")->procedure = bindrule("FIsDir")->procedure =
  ...
  bindrule("HdrMacro")->procedure = bindrule("HDRMACRO")->procedure =
    parse_make(builtin_hdrmacro, P0, P0, P0, C0, C0, 0);

  bindrule("Bash")->procedure = bindrule("BASH")->procedure =
    parse_make(builtin_bash, P0, P0, P0, C0, C0, 0);

  bindrule("ExecCmd")->procedure = bindrule("EXECCMD")->procedure =
    parse_make(builtin_execcmd, P0, P0, P0, C0, C0, 0);

  bindrule("Subst")->procedure = bindrule("SUBST")->procedure =
  ...
  bindrule("Math")->procedure = bindrule("MATH")->procedure =
  ...
  bindrule("Split")->procedure = bindrule("SPLIT")->procedure =
  ...
  bindrule("StrAfter")->procedure = bindrule("STRAFTER")->procedure =
    parse_make(builtin_strafter, P0, P0, P0, C0, C0, 0);
  bindrule("StrAfterI")->procedure = bindrule("STRAFTERI")->procedure =
    parse_make(builtin_strafteri, P0, P0, P0, C0, C0, 0);

  bindrule("Sort")->procedure = bindrule("SORT")->procedure =
    parse_make(builtin_sort, P0, P0, P0, C0, C0, 0);
  bindrule("SortI")->procedure = bindrule("SORTI")->procedure =
    parse_make(builtin_sorti, P0, P0, P0, C0, C0, 0);

  bindrule("Sha256")->procedure = bindrule("SHA256")->procedure =
    parse_make(builtin_sha256, P0, P0, P0, C0, C0, 0);

  bindrule("Sha256_128")->procedure = bindrule("SHA256_128")->procedure =
    parse_make(builtin_sha256_128, P0, P0, P0, C0, C0, 0);

  bindrule("Sha256_64")->procedure = bindrule("SHA256_64")->procedure =
