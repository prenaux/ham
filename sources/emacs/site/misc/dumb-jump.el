...
(defcustom dumb-jump-language-file-exts
  '((:language "elisp" :ext "el" :agtype "elisp" :rgtype "elisp")
    ...
    (:language "c++" :ext "cni" :agtype "cpp" :rgtype "cpp")
    (:language "c++" :ext "cpp2" :agtype "cpp" :rgtype "cpp")
    (:language "c++" :ext "cppni" :agtype "cpp" :rgtype "cpp")
    (:language "c++" :ext "cppm" :agtype "cpp" :rgtype "cpp")
