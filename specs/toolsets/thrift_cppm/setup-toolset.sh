...
BUILD=ra ham-cppm-build-check thrift_cppm noheader thrift_cppm thrift_cppm ham_thriftc || return 1
BUILD=da ham-cppm-build-check thrift_cppm noheader thrift_cppm thrift_cppm ham_thriftc || return 1
