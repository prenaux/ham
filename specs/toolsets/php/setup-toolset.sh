...
case $HAM_OS in
  ...
  LINUX*)
    if [ -z "$(where_inpath "php$HAM_PHP_VERSION")" ]; then
      ...
      (
        set -ex
        ham-apt-get-install php7.4-common php7.4-mysql php7.4-xml php7.4-xmlrpc php7.4-curl php7.4-gd php7.4-imagick php7.4-cli php7.4-dev php7.4-imap php7.4-mbstring php7.4-opcache php7.4-pgsql php7.4-soap php7.4-sqlite3 php7.4-zip php7.4-intl php7.4-fpm
      ) || return 1
      if [ -z "$(where_inpath "php$HAM_PHP_VERSION")" ]; then
