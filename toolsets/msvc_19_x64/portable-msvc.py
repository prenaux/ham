#!/usr/bin/env python3
#
# cf: https://gist.github.com/mmozeiko/7f3162ec2988e81e56d5c4e22cde9977
#
# This downloads standalone MSVC compiler, linker & other tools, also
# headers/libraries from Windows SDK into portable folder, without installing
# Visual Studio. Has bare minimum components - no UWP/Store/WindowsRT stuff,
# just files & tools for native desktop app development.
#
# Run py.exe portable-msvc.py and it will download output into msvc folder. By
# default it will download latest available MSVC & Windows SDK - currently
# v14.40.33807 and v10.0.26100.0.
#
# You can list available versions with py.exe portable-msvc.py --show-versions
# and then pass versions you want with --msvc-version and --sdk-version
# arguments.
#
# To use with CUDA create empty VC/Auxiliary/Builds/vcvars64.bat &
